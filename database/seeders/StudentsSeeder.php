...
class StudentsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Student::create(['workload_id' => 1, 'colaborator_id' => 8, 'promotion_id' => 6, "nr_students" => 5,  "temporary" => false]);
        Student::create(['workload_id' => 1, 'colaborator_id' => 8, 'promotion_id' => 4, "nr_students" => 10, "temporary" => false]);
        Student::create(['workload_id' => 1, 'colaborator_id' => 8, 'promotion_id' => 2, "nr_students" => 39, "temporary" => false]);
    }
}
